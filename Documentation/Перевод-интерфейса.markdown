...
Модуль [Translation Manager](https://gallery.orchardproject.net/List/Modules/Orchard.Module.Vandelay.TranslationManager), доступный в Галерее Orchard добавляет команды для более гибкого управления файлами переводов.
